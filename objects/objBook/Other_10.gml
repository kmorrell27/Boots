...
switch (choice_variable) {
  case -1:
    ...
    myScripts[i] = [
      [create_instance_layer, 170, 120, global.playerLayer, obj_emote],
      [create_instance_layer, 170, 120, global.playerLayer, objBook]
    ];
    myNextLine[i] = [0, 0];
    ...
    i++;
    myText[i] = [
      "(sarcastically) Blue is the best colour.",
